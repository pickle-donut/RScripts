...
file.exists("C:\\Users\\jonmc\\Documents\\git\\RScripts\\ml\\data\\general\\ozone.data.txt")
...
ozone_data = read.table("C:\\Users\\jonmc\\Documents\\git\\RScripts\\ml\\data\\general\\ozone.data.txt", header=T, sep="\t")
...
stdt_data = read.table("C:\\Users\\jonmc\\Documents\\git\\RScripts\\ml\\data\\general\\class_performance.txt",sep="\t",header=T)
...
afib_data = read.table("C:\\Users\\Bryan\\OneDrive - Oklahoma State University\\Teaching\\MSIS 5023\\In-Class Exercises\\Data\\afib_data.txt", header=T, sep="\t")

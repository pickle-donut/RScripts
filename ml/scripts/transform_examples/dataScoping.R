...
reduction_data = read.table("C:\\Users\\jonmc\\Documents\\git\\RScripts\\ml\\data\\general\\datareduction.csv", header=T, sep=",")
...
#Alternative Data
reduc_data = read.table("C:\\Users\\jonmc\\Documents\\git\\RScripts\\ml\\data\\general\\reduction_data_new.txt", header=T, sep="\t")
names(reduc_data)

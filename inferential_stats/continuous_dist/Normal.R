...
print(paste("There is ",  
            round(1 - pnorm(30, 28, 5, lower.tail = TRUE, log.p = FALSE),4), 
      "probability that at least 30% of 18 to 34 year old Facebook users check their profile before getting out of bed"))
#
print(paste("There is a 95% probability that at most",  
            round(qnorm(0.95, 28, 5, lower.tail = TRUE, log.p = FALSE),4), 
